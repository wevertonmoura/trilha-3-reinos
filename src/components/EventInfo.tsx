  ...
  return (
    <div className="lg:col-span-2 space-y-16">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        <InfoRow icon={<Calendar />} title="Data" text="02 de setembro de 2026" />
      ...
      <section className="space-y-6">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-zinc-800/40 p-6 rounded-2xl border border-zinc-700/50 flex gap-5"><Ticket className="text-emerald-500 shrink-0" size={32}/><div><h4 className="font-bold text-white uppercase text-sm mb-2 tracking-widest">Investimento</h4><p className="text-sm text-zinc-400 leading-relaxed">R$ 55,00 (Individual) ou R$ 100,00 (Você + 1 Amigo). Vagas limitadas.</p></div></div>
