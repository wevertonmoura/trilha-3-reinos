...
  const [selectedImg, setSelectedImg] = useState<string | null>(null); // Para o Zoom da foto
  
...
  const linkInstagram = "https://instagram.com/SEU_INSTAGRAM_AQUI"; // <-- COLE O LINK DO INSTA AQUI
  const valorIngresso = 20; 
  const taxaPix = 0.20; // <-- ADICIONE ESTA LINHA

  // <-- ADICIONE ESTA FUNÇÃO AQUI (Antes do useEffect)
...
  // EFEITO DA SPLASH SCREEN (Some após 2.5 segundos)
  useEffect(() => {
...
            >
              {/* Se você tiver a imagem da sua logo, apague o h1 abaixo e cole: <img src="/logo.png" alt="Invasores" className="w-48 h-48 object-contain" /> */}
              <img 
  src="/logo.png" 
  alt="Invasores" 
  className="w-40 h-40 object-cover rounded-full border-4 border-zinc-900 shadow-[0_0_25px_rgba(16,185,129,0.3)]" 
/>
              
...
              <a 
                href="https://www.google.com/maps/place/?q=place_id:ChIJ4-tYpb8RqwcRxSQFPEP7it4" 
                target="_blank" 
...
                  <div>
                    <h4 className="font-bold text-white uppercase text-sm mb-2 tracking-widest">Pagamento via PIX</h4>
                    <p className="text-sm text-zinc-400 leading-relaxed">
                      A confirmação é automática via PIX. Há um acréscimo de uma pequena taxa de sistema no valor de <strong className="text-emerald-500">R$ 0,20</strong> por transação.
                    </p>
                  </div>
                </div>
...
       {/* NOVO RODAPÉ COM HASHTAG E INSTAGRAM (ADAPTADO PARA O TEMA DA TRILHA) */}
...
              <h4 className="text-white font-black uppercase tracking-widest mb-2 flex items-center justify-center gap-2 text-sm">

                Faça parte da família <Users size={16} className="text-emerald-500"/>

              </h4>

              <p className="text-zinc-400 text-xs mb-6 px-2 leading-relaxed">

                Acompanhe nossa rotina, tire dúvidas e venha correr com a gente. <br/><span className="text-emerald-500 font-bold mt-2 block">#Invasores </span>
...
                <motion.a whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} href={linkInstagram} target="_blank" className="flex-1 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 text-white font-black py-3 px-4 rounded-xl shadow-lg shadow-purple-900/30 flex items-center justify-center gap-2 text-[11px] uppercase tracking-widest">

                  <Instagram size={16} /> Siga no Insta

                </motion.a>

                <motion.a whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} href={linkGrupoWhats} target="_blank" className="flex-1 bg-emerald-600 hover:bg-emerald-500 text-white font-black py-3 px-4 rounded-xl shadow-lg shadow-emerald-900/20 flex items-center justify-center gap-2 text-[11px] uppercase tracking-widest">

                  <MessageCircle size={16} /> Entra no Grupo
